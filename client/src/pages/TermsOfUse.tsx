      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12">
        ...
        <div className="mb-8">
          ...
          <div className="mt-4 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 text-sm text-amber-800">
            Ao acessar ou utilizar o EduPlate Menu, você concorda com os presentes Termos. Se não concordar, não utilize a plataforma.
          </div>
        </div>
        ...
        <Section title="1. Das partes e do objeto">
          <p>O <strong>EduPlate Menu</strong> é uma plataforma SaaS (Software como Serviço) para gestão digital da alimentação escolar, desenvolvida e operada por:</p>
          ...
          <p className="mt-3">A plataforma é oferecida para Secretarias Municipais de Educação, nutricionistas responsáveis técnicos e entidades executoras do Programa Nacional de Alimentação Escolar (PNAE — Lei nº 11.947/2009).</p>
          <p className="mt-2">Ao criar uma conta ou utilizar o EduPlate Menu, o usuário declara ter lido, compreendido e aceito integralmente estes Termos de Uso.</p>
        </Section>
        ...
        <Section title="3. Funcionalidades disponíveis">
          <p>O EduPlate Menu oferece, conforme o plano contratado:</p>
          <List items={[
        ...
        <Section title="5. Responsabilidades da plataforma">
          <p>O EduPlate Menu compromete-se a:</p>
          <List items={[
        ...
        <Section title="6. Planos e pagamentos">
          <p>O acesso ao EduPlate Menu é oferecido em planos pagos, com cobrança mensal ou anual conforme contrato. O não pagamento por mais de 30 dias corridos pode resultar em suspensão temporária do acesso.</p>
        ...
        <Section title="7. Propriedade intelectual">
          <p>Todo o código-fonte, design, algoritmos e documentação do EduPlate Menu são de propriedade exclusiva dos seus desenvolvedores, protegidos pela Lei nº 9.609/1998 e Lei nº 9.610/1998.</p>
        ...
        <Section title="8. Privacidade e proteção de dados">
          <p>O tratamento de dados pessoais realizado pelo EduPlate Menu é regido pela nossa <strong>Política de Privacidade</strong>, disponível nesta plataforma, em conformidade com a LGPD (Lei nº 13.709/2018).</p>
        </Section>
        ...
        <Section title="10. Limitação de responsabilidade">
          <p>Em nenhuma hipótese o EduPlate Menu será responsável por danos indiretos, perda de receita, perda de dados (salvo por falha nossa) ou lucros cessantes. Nossa responsabilidade total está limitada ao valor pago pelo usuário nos últimos 12 meses.</p>
        </Section>
        ...
        <Section title="12. Lei aplicável e foro">
          <p>Estes Termos são regidos pela legislação brasileira, incluindo o Código Civil (Lei nº 10.406/2002), o Código de Defesa do Consumidor (Lei nº 8.078/1990), a Lei de Software (nº 9.609/1998), o Marco Civil da Internet (Lei nº 12.965/2014) e a LGPD (Lei nº 13.709/2018).</p>
          <p className="mt-2">Eventuais disputas serão resolvidas preferencialmente por conciliação extrajudicial e, se necessário, no foro da comarca de <strong>Avaré — SP</strong>, com exclusão de qualquer outro, por mais privilegiado que seja.</p>
        </Section>

        <Section title="13. Contato">
          <div className="bg-gray-50 rounded-xl p-4 text-sm space-y-1">
            <p><strong>Suporte técnico:</strong> contato@eduplate.com.br</p>
            <p><strong>Encarregado de Dados (DPO):</strong> contato@eduplate.com.br</p>
          </div>
        </Section>

        <div className="mt-10 pt-6 border-t border-gray-100 text-center text-xs text-gray-400">
          EduPlate Menu · Termos de Uso v1.0 · {new Date().getFullYear()}
        </div>
      </div>
    </div>
  );
